...
public class SelfieRecordAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            selfieRecordView.checkBoxSelected = newView.findViewById(R.id.checkbox_selected);
            selfieRecordView.thumbnail = newView.findViewById(R.id.thumbnail);
            selfieRecordView.selfieDate = newView.findViewById(R.id.selfie_date);
